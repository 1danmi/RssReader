...
namespace BE
{
    public class FeedViewModelBase : BindableBase
    {
        /// <summary>
        /// Initializes a new instance of the FeedViewModel class. 
        /// </summary>
        public FeedViewModelBase()
        {
            Articles = new ObservableCollection<ArticleViewModelBase>();
        ...
        /// </summary>
        public ObservableCollection<ArticleViewModelBase> Articles { get; }
